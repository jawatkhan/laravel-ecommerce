...
<section id="do_action">
	<div class="container">
		...
		<div class="paymentCont col-sm-8">
			...
			<form action="{{ url('/order-place') }}" method="post" class="text-center">
						{{ csrf_field() }}   
            <input type="radio" name="payment_method" value="cash" checked>  Cash
            <input type="radio" name="payment_method" value="card" checked>  Debit Card
            <input type="radio" name="payment_method" value="paypal" checked>  Paypal
            <input class="btn btn-success" type="submit" name="" value="Done">
				 </form>       
			 </div>
	</div>
</section><!--/#do_action-->
