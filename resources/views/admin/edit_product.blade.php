						...
						<form class="form-horizontal" action="{{ url('/update-product',$product_info->product_id) }}" method="post" enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" value="{{ $product_info->product_name }}" name="product_name" required />
							  </div>
							</div>
                           ...
                           <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" value="{{ $product_info->product_price }}" name="product_price" required />
							  </div>
							</div>
