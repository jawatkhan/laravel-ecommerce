...
<div class="row-fluid sortable">
	<div class="box span6">
		<div class="box-header">
			<h2><i class="halglings-icon align-justify"></i><span class="break"></span>Customer Details</h2>
		</div>
	...
	<div class="box span6">
		<div class="box-header">
			<h2><i class="halglings-icon align-justify"></i><span class="break"></span>Shipping Details</h2>
		</div>
		<div class="box-content">
			<table class="table">
				<thead>
	...
	<div class="box span12">
		<div class="box-header data-orginal-title">
			<h2><i class="halglings-icon align-justify"></i><span class="break"></span>Order Details</h2>
		</div>
		<div class="box-content">
			<table class="table">
				<thead>
				...
				<tfoot>
					<tr>
						...
						<td><strong>TK. = {{ $v_order->order_total }}</strong></td>
					</tr>
				</tfoot>
			</table>
		</div>
